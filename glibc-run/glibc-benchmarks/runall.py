...
confs.append(Conf(None, "dev-memcpy0"))
confs.append(Conf(None, "dev-memcpy1"))
confs.append(Conf(None, "dev-memcpy2"))
confs.append(Conf(None, "dev-memcpy3"))
confs.append(Conf(None, "dev-memcpy4"))


confs.append(Conf(None, "glibc-memcpy0"))
confs.append(Conf(None, "glibc-memcpy1"))
confs.append(Conf(None, "glibc-memcpy2"))
confs.append(Conf(None, "glibc-memcpy3"))
