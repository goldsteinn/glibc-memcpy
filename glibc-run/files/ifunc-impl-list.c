			...
			size_t max)
{
  ...
  IFUNC_IMPL (i, name, memmove,
	      ...
	      IFUNC_IMPL_ADD (array, i, memmove, 1,
   	      ...
   	      IFUNC_IMPL_ADD (array, i, memmove,
			      CPU_FEATURE_USABLE (AVX512VL),
			      __memmove_avx512_unaligned_dev)
	      IFUNC_IMPL_ADD (array, i, memmove,
			      CPU_FEATURE_USABLE (AVX512VL),
			      __memmove_avx512_unaligned_erms_dev)
   	      IFUNC_IMPL_ADD (array, i, memmove,
			      CPU_FEATURE_USABLE (AVX512VL),
			      __memmove_evex_unaligned_dev)
	      IFUNC_IMPL_ADD (array, i, memmove,
			      CPU_FEATURE_USABLE (AVX512VL),
			      __memmove_evex_unaligned_erms_dev)
   	      IFUNC_IMPL_ADD (array, i, memmove,
			      CPU_FEATURE_USABLE (AVX),
			      __memmove_avx2_unaligned_dev)
	      IFUNC_IMPL_ADD (array, i, memmove,
			      CPU_FEATURE_USABLE (AVX),
			      __memmove_avx2_unaligned_erms_dev)
   	      IFUNC_IMPL_ADD (array, i, memmove, 1,
  ...
  IFUNC_IMPL (i, name, memcpy,
	      ...
	      IFUNC_IMPL_ADD (array, i, memcpy, 1, __memcpy_erms)
   	      ...
   	      IFUNC_IMPL_ADD (array, i, memcpy,
			      CPU_FEATURE_USABLE (AVX512VL),
			      __memcpy_avx512_unaligned_dev)
	      IFUNC_IMPL_ADD (array, i, memcpy,
			      CPU_FEATURE_USABLE (AVX512VL),
			      __memcpy_avx512_unaligned_erms_dev)
   	      IFUNC_IMPL_ADD (array, i, memcpy,
			      CPU_FEATURE_USABLE (AVX512VL),
			      __memcpy_evex_unaligned_dev)
	      IFUNC_IMPL_ADD (array, i, memcpy,
			      CPU_FEATURE_USABLE (AVX512VL),
			      __memcpy_evex_unaligned_erms_dev)
   	      IFUNC_IMPL_ADD (array, i, memcpy,
			      CPU_FEATURE_USABLE (AVX),
			      __memcpy_avx2_unaligned_dev)
	      IFUNC_IMPL_ADD (array, i, memcpy,
			      CPU_FEATURE_USABLE (AVX),
			      __memcpy_avx2_unaligned_erms_dev)
   	      IFUNC_IMPL_ADD (array, i, memcpy, 1,
